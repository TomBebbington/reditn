...
"100%";h.onchange=function(){m.data.get("sub-tags").set(c,h.value);e.innerHTML=k.htmlEscape(h.value)+" ";m.save();a.parentNode.removeChild(a)};a.appendChild(h);j.fullPopUp(a,g.offsetTop+g.offsetHeight);h.focus()};a.parentNode.insertBefore(b,a.nextSibling)};var p=h.ValueType={__ename__:["ValueType"],__constructs__:"TNull TInt TFloat TBool TObject TFunction TClass TEnum TUnknown".split(" ")};p.TNull=["TNull",0];p.TNull.toString=u;p.TNull.__enum__=p;p.TInt=["TInt",1];p.TInt.toString=u;p.TInt.__enum__=
p;p.TFloat=["TFloat",2];p.TFloat.toString=u;p.TFloat.__enum__=p;p.TBool=["TBool",3];p.TBool.toString=u;p.TBool.__enum__=p;p.TObject=["TObject",4];p.TObject.toString=u;p.TObject.__enum__=p;p.TFunction=["TFunction",5];p.TFunction.toString=u;p.TFunction.__enum__=p;p.TClass=function(a){a=["TClass",6,a];a.__enum__=p;a.toString=u;return a};p.TEnum=function(a){a=["TEnum",7,a];a.__enum__=p;a.toString=u;return a};p.TUnknown=["TUnknown",8];p.TUnknown.toString=u;p.TUnknown.__enum__=p;var t=function(){};h.Type=
t;t.__name__=["Type"];t.getClassName=function(a){return a.__name__.join(".")};t.getEnumName=function(a){return a.__ename__.join(".")};t.resolveClass=function(a){a=h[a];return null==a||!a.__name__?null:a};t.resolveEnum=function(a){a=h[a];return null==a||!a.__ename__?null:a};t.createEmptyInstance=function(a){function b(){}b.prototype=a.prototype;return new b};t.createEnum=function(a,b,c){var d=v.field(a,b);if(null==d)throw"No such constructor "+b;if(v.isFunction(d)){if(null==c)throw"Constructor "+b+
...
a.__ename__?p.TObject:p.TFunction;case "undefined":return p.TNull;default:return p.TUnknown}};var E=function(){};h.UserInfo=E;E.__name__=["UserInfo"];E.init=function(){for(var a=f.Browser.document.body.getElementsByClassName("author"),b=0;b<a.length;){var c=a[b];++b;c.onmouseover=E._onMouseOverUser}};E._onMouseOverUser=function(a){var b=a.target,c=b.innerHTML,c=g.substr(c,c.lastIndexOf("/")+1,null);a=f.Browser.document.createElement("div");j.popUp(b,a,b.offsetLeft+b.offsetWidth,b.offsetTop);var b=
j.getData(e.Json.parse(e.Http.requestUrl("/user/"+c+"/about.json"))),d=b.name,k=j.age(b.created_utc),c=j.formatNumber(b.link_karma),h=j.formatNumber(b.comment_karma),d="<b>User:</b> "+d+"<br>"+("<b>Account age:</b> "+k+"<br>"),d=d+("<b>Karma:</b> "+c+" link karma, "+h+" comment karma");b.is_mod&&(d+="<br><b>Moderator</b>");b.is_gold&&(d+="<br><b>Gold</b>");a.innerHTML=d};var F=function(){};h.UserTagger=F;F.__name__=["UserTagger"];F.init=function(){for(var a=f.Browser.document.body.getElementsByClassName("author"),
b=0;b<a.length;){var c=a[b];++b;F.getTag(c)}};F.getTag=function(a){var b=f.Browser.document.createElement("span"),c=k.trim(a.innerHTML),d=m.data.get("user-tags").exists(c)?m.data.get("user-tags").get(c):null;b.className="flair";var e=f.Browser.document.createElement("span");e.innerHTML=null==d?"":k.htmlEscape(d)+" ";b.appendChild(e);var g=f.Browser.document.createElement("a");g.href="javascript:void(0);";g.innerHTML="[+]";b.appendChild(g);g.onclick=function(){var a=f.Browser.document.createElement("div"),
b=f.Browser.document.createElement("label");b.setAttribute("for","tag-change");b.innerHTML="Tag for "+c+" ";a.appendChild(b);var h=f.Browser.document.createElement("input");h.name="tag-change";h.value=d;h.style.width="100%";h.onchange=function(){m.data.get("user-tags").set(c,h.value);e.innerHTML=k.htmlEscape(h.value)+" ";m.save();a.parentNode.removeChild(a)};a.appendChild(h);j.fullPopUp(a,g.offsetTop+g.offsetHeight);h.focus()};a.parentNode.insertBefore(b,a.nextSibling)};var r={};r.LinkType=h["data.LinkType"]=
{__ename__:["data","LinkType"],__constructs__:["IMAGE","VIDEO","AUDIO","TEXT","UNKNOWN"]};r.LinkType.IMAGE=["IMAGE",0];r.LinkType.IMAGE.toString=u;r.LinkType.IMAGE.__enum__=r.LinkType;r.LinkType.VIDEO=["VIDEO",1];r.LinkType.VIDEO.toString=u;r.LinkType.VIDEO.__enum__=r.LinkType;r.LinkType.AUDIO=["AUDIO",2];r.LinkType.AUDIO.toString=u;r.LinkType.AUDIO.__enum__=r.LinkType;r.LinkType.TEXT=["TEXT",3];r.LinkType.TEXT.toString=u;r.LinkType.TEXT.__enum__=r.LinkType;r.LinkType.UNKNOWN=["UNKNOWN",4];r.LinkType.UNKNOWN.toString=
u;r.LinkType.UNKNOWN.__enum__=r.LinkType;e.Http=function(a){this.url=a;this.headers=new e.ds.StringMap;this.params=new e.ds.StringMap;this.async=!0};h["haxe.Http"]=e.Http;e.Http.__name__=["haxe","Http"];e.Http.requestUrl=function(a){a=new e.Http(a);a.async=!1;var b=null;a.onData=function(a){b=a};a.onError=function(a){throw a;};a.request(!1);return b};e.Http.prototype={onStatus:function(){},onError:function(){},onData:function(){},request:function(a){var b=this;b.responseData=null;var c=f.Browser.createXMLHttpRequest(),
d=function(){if(4==c.readyState){var a;try{a=c.status}catch(d){a=null}void 0==a&&(a=null);if(null!=a)b.onStatus(a);if(null!=a&&200<=a&&400>a)b.onData(b.responseData=c.responseText);else if(null==a)b.onError("Failed to connect or resolve host");else switch(a){case 12029:b.onError("Failed to connect to host");break;case 12007:b.onError("Unknown host");break;default:b.responseData=c.responseText,b.onError("Http Error #"+c.status)}}};this.async&&(c.onreadystatechange=d);var e=this.postData;if(null!=e)a=
!0;else for(var g=this.params.keys();g.hasNext();)var h=g.next(),e=null==e?"":e+"&",e=e+(k.urlEncode(h)+"="+k.urlEncode(this.params.get(h)));try{if(a)c.open("POST",this.url,this.async);else if(null!=e){var j=1>=this.url.split("?").length;c.open("GET",this.url+(j?"?":"&")+e,this.async);e=null}else c.open("GET",this.url,this.async)}catch(l){this.onError(l.toString());return}null==this.headers.get("Content-Type")&&(a&&null==this.postData)&&c.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
for(a=this.headers.keys();a.hasNext();)g=a.next(),c.setRequestHeader(g,this.headers.get(g));c.send(e);this.async||d(null)},setHeader:function(a,b){this.headers.set(a,b);return this},__class__:e.Http};e.Json=function(){};h["haxe.Json"]=e.Json;e.Json.__name__=["haxe","Json"];e.Json.parse=function(a){return(new e.Json).doParse(a)};e.Json.prototype={parseNumber:function(a){for(var b=this.pos-1,c=45==a,d=!c,e=48==a,f=!1,h=!1,j=!1,k=!1;;){a=this.str.charCodeAt(this.pos++);switch(a){case 48:e&&!f&&this.invalidNumber(b);
c&&(c=!1,e=!0);d=!0;break;case 49:case 50:case 51:case 52:case 53:case 54:case 55:case 56:case 57:e&&!f&&this.invalidNumber(b);c&&(c=!1);d=!0;e=!1;break;case 46:(c||f)&&this.invalidNumber(b);d=!1;f=!0;break;case 101:case 69:(c||e||h)&&this.invalidNumber(b);d=!1;h=!0;break;case 43:case 45:(!h||j)&&this.invalidNumber(b);d=!1;j=!0;break;default:d||this.invalidNumber(b),this.pos--,k=!0}if(k)break}a=q.parseFloat(g.substr(this.str,b,this.pos-b));b=a|0;return b==a?b:a},invalidNumber:function(a){throw"Invalid number at position "+
a+": "+g.substr(this.str,a,this.pos-a);},parseString:function(){for(var a=this.pos,b=new A;;){var c=this.str.charCodeAt(this.pos++);if(34==c)break;if(92==c){b.addSub(this.str,a,this.pos-a-1);c=this.str.charCodeAt(this.pos++);switch(c){case 114:b.b+="\r";break;case 110:b.b+="\n";break;case 116:b.b+="\t";break;case 98:b.b+="\b";break;case 102:b.b+="\f";break;case 47:case 92:case 34:b.b+=String.fromCharCode(c);break;case 117:a=q.parseInt("0x"+g.substr(this.str,this.pos,4));this.pos+=4;b.b+=String.fromCharCode(a);
break;default:throw"Invalid escape sequence \\"+String.fromCharCode(c)+" at position "+(this.pos-1);}a=this.pos}else if(c!=c)throw"Unclosed string";}b.addSub(this.str,a,this.pos-a-1);return b.b},parseRec:function(){for(;;){var a=this.str.charCodeAt(this.pos++);switch(a){case 32:case 13:case 10:case 9:break;case 123:for(var b={},c=null,a=null;;){var d=this.str.charCodeAt(this.pos++);switch(d){case 32:case 13:case 10:case 9:break;case 125:return(null!=c||!1==a)&&this.invalidChar(),b;case 58:null==c&&
this.invalidChar();b[c]=this.parseRec();c=null;a=!0;break;case 44:a?a=!1:this.invalidChar();break;case 34:a&&this.invalidChar();c=this.parseString();break;default:this.invalidChar()}}break;case 91:b=[];for(a=null;;)switch(d=this.str.charCodeAt(this.pos++),d){case 32:case 13:case 10:case 9:break;case 93:return!1==a&&this.invalidChar(),b;case 44:a?a=!1:this.invalidChar();break;default:a&&this.invalidChar(),this.pos--,b.push(this.parseRec()),a=!0}break;case 116:a=this.pos;if(114!=this.str.charCodeAt(this.pos++)||
117!=this.str.charCodeAt(this.pos++)||101!=this.str.charCodeAt(this.pos++))this.pos=a,this.invalidChar();return!0;case 102:a=this.pos;if(97!=this.str.charCodeAt(this.pos++)||108!=this.str.charCodeAt(this.pos++)||115!=this.str.charCodeAt(this.pos++)||101!=this.str.charCodeAt(this.pos++))this.pos=a,this.invalidChar();return!1;case 110:a=this.pos;if(117!=this.str.charCodeAt(this.pos++)||108!=this.str.charCodeAt(this.pos++)||108!=this.str.charCodeAt(this.pos++))this.pos=a,this.invalidChar();return null;
case 34:return this.parseString();case 48:case 49:case 50:case 51:case 52:case 53:case 54:case 55:case 56:case 57:case 45:return this.parseNumber(a);default:this.invalidChar()}}},invalidChar:function(){this.pos--;throw"Invalid char "+this.str.charCodeAt(this.pos)+" at position "+this.pos;},doParse:function(a){this.str=a;this.pos=0;return this.parseRec()},__class__:e.Json};e.Serializer=function(){this.buf=new A;this.cache=[];this.useCache=e.Serializer.USE_CACHE;this.useEnumIndex=e.Serializer.USE_ENUM_INDEX;
this.shash=new e.ds.StringMap;this.scount=0};h["haxe.Serializer"]=e.Serializer;e.Serializer.__name__=["haxe","Serializer"];e.Serializer.run=function(a){var b=new e.Serializer;b.serialize(a);return b.toString()};e.Serializer.prototype={serialize:function(a){var b=t["typeof"](a);switch(b[1]){case 0:this.buf.b+="n";break;case 1:if(0==a){this.buf.b+="z";break}this.buf.b+="i";this.buf.b+=q.string(a);break;case 2:Math.isNaN(a)?this.buf.b+="k":Math.isFinite(a)?(this.buf.b+="d",this.buf.b+=q.string(a)):this.buf.b+=
q.string(0>a?"m":"p");break;case 3:this.buf.b+=q.string(a?"t":"f");break;case 6:b=b[2];if(b==String){this.serializeString(a);break}if(this.useCache&&this.serializeRef(a))break;switch(b){case Array:var c=0;this.buf.b+="a";for(var d=a.length,f=0;f<d;)b=f++,null==a[b]?c++:(0<c&&(1==c?this.buf.b+="n":(this.buf.b+="u",this.buf.b+=q.string(c)),c=0),this.serialize(a[b]));0<c&&(1==c?this.buf.b+="n":(this.buf.b+="u",this.buf.b+=q.string(c)));this.buf.b+="h";break;case B:this.buf.b+="l";for(a=a.iterator();a.hasNext();)b=
a.next(),this.serialize(b);this.buf.b+="h";break;case Date:this.buf.b+="v";this.buf.b+=q.string(g.dateStr(a));break;case e.ds.StringMap:this.buf.b+="b";for(c=a.keys();c.hasNext();)b=c.next(),this.serializeString(b),this.serialize(a.get(b));this.buf.b+="h";break;case e.ds.IntMap:this.buf.b+="q";for(c=a.keys();c.hasNext();)b=c.next(),this.buf.b+=":",this.buf.b+=q.string(b),this.serialize(a.get(b));this.buf.b+="h";break;case e.ds.ObjectMap:this.buf.b+="M";for(c=a.keys();c.hasNext();)b=c.next(),d=v.field(b,
"__id__"),v.deleteField(b,"__id__"),this.serialize(b),b.__id__=d,this.serialize(a.h[b.__id__]);this.buf.b+="h";break;case e.io.Bytes:b=0;c=a.length-2;d=new A;for(f=e.Serializer.BASE64;b<c;){var h=a.b[b++],j=a.b[b++],k=a.b[b++];d.b+=q.string(f.charAt(h>>2));d.b+=q.string(f.charAt((h<<4|j>>4)&63));d.b+=q.string(f.charAt((j<<2|k>>6)&63));d.b+=q.string(f.charAt(k&63))}b==c?(h=a.b[b++],j=a.b[b++],d.b+=q.string(f.charAt(h>>2)),d.b+=q.string(f.charAt((h<<4|j>>4)&63)),d.b+=q.string(f.charAt(j<<2&63))):b==
c+1&&(h=a.b[b++],d.b+=q.string(f.charAt(h>>2)),d.b+=q.string(f.charAt(h<<4&63)));b=d.b;this.buf.b+="s";this.buf.b+=q.string(b.length);this.buf.b+=":";this.buf.b+=q.string(b);break;default:this.cache.pop(),null!=a.hxSerialize?(this.buf.b+="C",this.serializeString(t.getClassName(b)),this.cache.push(a),a.hxSerialize(this),this.buf.b+="g"):(this.buf.b+="c",this.serializeString(t.getClassName(b)),this.cache.push(a),this.serializeFields(a))}break;case 4:if(this.useCache&&this.serializeRef(a))break;this.buf.b+=
"o";this.serializeFields(a);break;case 7:b=b[2];if(this.useCache&&this.serializeRef(a))break;this.cache.pop();this.buf.b+=q.string(this.useEnumIndex?"j":"w");this.serializeString(t.getEnumName(b));this.useEnumIndex?(this.buf.b+=":",this.buf.b+=q.string(a[1])):this.serializeString(a[0]);this.buf.b+=":";d=a.length;this.buf.b+=q.string(d-2);for(f=2;f<d;)b=f++,this.serialize(a[b]);this.cache.push(a);break;case 5:throw"Cannot serialize function";default:throw"Cannot serialize "+q.string(a);}},serializeFields:function(a){for(var b=
0,c=v.fields(a);b<c.length;){var d=c[b];++b;this.serializeString(d);this.serialize(v.field(a,d))}this.buf.b+="g"},serializeRef:function(a){for(var b=typeof a,c=0,d=this.cache.length;c<d;){var e=c++,f=this.cache[e];if(typeof f==b&&f==a)return this.buf.b+="r",this.buf.b+=q.string(e),!0}this.cache.push(a);return!1},serializeString:function(a){var b=this.shash.get(a);null!=b?(this.buf.b+="R",this.buf.b+=q.string(b)):(this.shash.set(a,this.scount++),this.buf.b+="y",a=k.urlEncode(a),this.buf.b+=q.string(a.length),
this.buf.b+=":",this.buf.b+=q.string(a))},toString:function(){return this.buf.b},__class__:e.Serializer};e.Timer=function(a){var b=this;this.id=setInterval(function(){b.run()},a)};h["haxe.Timer"]=e.Timer;e.Timer.__name__=["haxe","Timer"];e.Timer.stamp=function(){return(new Date).getTime()/1E3};e.Timer.prototype={run:function(){console.log("run")},stop:function(){null!=this.id&&(clearInterval(this.id),this.id=null)},__class__:e.Timer};e.Unserializer=function(a){this.buf=a;this.length=a.length;this.pos=
0;this.scache=[];this.cache=[];a=e.Unserializer.DEFAULT_RESOLVER;null==a&&(a=t,e.Unserializer.DEFAULT_RESOLVER=a);this.setResolver(a)};h["haxe.Unserializer"]=e.Unserializer;e.Unserializer.__name__=["haxe","Unserializer"];e.Unserializer.initCodes=function(){for(var a=[],b=0,c=e.Unserializer.BASE64.length;b<c;){var d=b++;a[e.Unserializer.BASE64.charCodeAt(d)]=d}return a};e.Unserializer.run=function(a){return(new e.Unserializer(a)).unserialize()};e.Unserializer.prototype={unserialize:function(){switch(this.buf.charCodeAt(this.pos++)){case 110:return null;
case 116:return!0;case 102:return!1;case 122:return 0;case 105:return this.readDigits();case 100:for(var a=this.pos;;){var b=this.buf.charCodeAt(this.pos);if(43<=b&&58>b||101==b||69==b)this.pos++;else break}return q.parseFloat(g.substr(this.buf,a,this.pos-a));case 121:b=this.readDigits();if(58!=this.buf.charCodeAt(this.pos++)||this.length-this.pos<b)throw"Invalid string length";a=g.substr(this.buf,this.pos,b);this.pos+=b;a=k.urlDecode(a);this.scache.push(a);return a;case 107:return Math.NaN;case 109:return Math.NEGATIVE_INFINITY;
case 112:return Math.POSITIVE_INFINITY;case 97:var c=this.buf,a=[];for(this.cache.push(a);;){b=this.buf.charCodeAt(this.pos);if(104==b){this.pos++;break}117==b?(this.pos++,b=this.readDigits(),a[a.length+b-1]=null):a.push(this.unserialize())}return a;case 111:return b={},this.cache.push(b),this.unserializeObject(b),b;case 114:b=this.readDigits();if(0>b||b>=this.cache.length)throw"Invalid reference";return this.cache[b];case 82:b=this.readDigits();if(0>b||b>=this.scache.length)throw"Invalid string reference";
...
this.pos++;var c=this.readDigits(),d=t.getEnumConstructs(a)[c];if(null==d)throw"Unknown enum index "+b+"@"+c;b=this.unserializeEnum(a,d);this.cache.push(b);return b;case 108:b=new B;for(this.cache.push(b);104!=this.buf.charCodeAt(this.pos);)b.add(this.unserialize());this.pos++;return b;case 98:c=new e.ds.StringMap;for(this.cache.push(c);104!=this.buf.charCodeAt(this.pos);)a=this.unserialize(),c.set(a,this.unserialize());this.pos++;return c;case 113:c=new e.ds.IntMap;this.cache.push(c);for(b=this.buf.charCodeAt(this.pos++);58==
b;)a=this.readDigits(),c.set(a,this.unserialize()),b=this.buf.charCodeAt(this.pos++);if(104!=b)throw"Invalid IntMap format";return c;case 77:c=new e.ds.ObjectMap;for(this.cache.push(c);104!=this.buf.charCodeAt(this.pos);)a=this.unserialize(),c.set(a,this.unserialize());this.pos++;return c;case 118:return b=g.strDate(g.substr(this.buf,this.pos,19)),this.cache.push(b),this.pos+=19,b;case 115:b=this.readDigits();c=this.buf;if(58!=this.buf.charCodeAt(this.pos++)||this.length-this.pos<b)throw"Invalid bytes length";
d=e.Unserializer.CODES;null==d&&(d=e.Unserializer.initCodes(),e.Unserializer.CODES=d);for(var a=this.pos,f=b&3,h=a+(b-f),j=e.io.Bytes.alloc(3*(b>>2)+(2<=f?f-1:0)),l=0;a<h;){var m=d[c.charCodeAt(a++)],n=d[c.charCodeAt(a++)];j.b[l++]=(m<<2|n>>4)&255;m=d[c.charCodeAt(a++)];j.b[l++]=(n<<4|m>>2)&255;n=d[c.charCodeAt(a++)];j.b[l++]=(m<<6|n)&255}2<=f&&(m=d[c.charCodeAt(a++)],n=d[c.charCodeAt(a++)],j.b[l++]=(m<<2|n>>4)&255,3==f&&(m=d[c.charCodeAt(a++)],j.b[l++]=(n<<4|m>>2)&255));this.pos+=b;this.cache.push(j);
return j;case 67:b=this.unserialize();a=this.resolver.resolveClass(b);if(null==a)throw"Class not found "+b;b=t.createEmptyInstance(a);this.cache.push(b);b.hxUnserialize(this);if(103!=this.buf.charCodeAt(this.pos++))throw"Invalid custom data";return b}this.pos--;throw"Invalid char "+this.buf.charAt(this.pos)+" at position "+this.pos;},unserializeEnum:function(a,b){if(58!=this.buf.charCodeAt(this.pos++))throw"Invalid enum format";var c=this.readDigits();if(0==c)return t.createEnum(a,b);for(var d=[];0<
c--;)d.push(this.unserialize());return t.createEnum(a,b,d)},unserializeObject:function(a){for(;;){if(this.pos>=this.length)throw"Invalid object";if(103==this.buf.charCodeAt(this.pos))break;var b=this.unserialize();if(!f.Boot.__instanceof(b,String))throw"Invalid object key";var c=this.unserialize();a[b]=c}this.pos++},readDigits:function(){for(var a=0,b=!1,c=this.pos;;){var d=this.buf.charCodeAt(this.pos);if(d!=d)break;if(45==d){if(this.pos!=c)break;b=!0}else{if(48>d||57<d)break;a=10*a+(d-48)}this.pos++}b&&
...
a;this.b=b};h["haxe.io.Bytes"]=e.io.Bytes;e.io.Bytes.__name__=["haxe","io","Bytes"];e.io.Bytes.alloc=function(a){for(var b=[],c=0;c<a;)c++,b.push(0);return new e.io.Bytes(a,b)};e.io.Bytes.prototype={__class__:e.io.Bytes};var f={Boot:function(){}};h["js.Boot"]=f.Boot;f.Boot.__name__=["js","Boot"];f.Boot.__string_rec=function(a,b){if(null==a)return"null";if(5<=b.length)return"<...>";var c=typeof a;if("function"==c&&(a.__name__||a.__ename__))c="object";switch(c){case "object":if(a instanceof Array){if(a.__enum__){if(2==
a.length)return a[0];c=a[0]+"(";b+="\t";for(var d=2,e=a.length;d<e;)var g=d++,c=2!=g?c+(","+f.Boot.__string_rec(a[g],b)):c+f.Boot.__string_rec(a[g],b);return c+")"}d=a.length;c="[";b+="\t";for(e=0;e<d;)g=e++,c+=(0<g?",":"")+f.Boot.__string_rec(a[g],b);return c+"]"}try{e=a.toString}catch(h){return"???"}if(null!=e&&e!=Object.toString&&(c=a.toString(),"[object Object]"!=c))return c;e=null;c="{\n";b+="\t";d=null!=a.hasOwnProperty;for(e in a)if(!d||a.hasOwnProperty(e))"prototype"==e||("__class__"==e||
"__super__"==e||"__interfaces__"==e||"__properties__"==e)||(2!=c.length&&(c+=", \n"),c+=b+e+" : "+f.Boot.__string_rec(a[e],b));b=b.substring(1);return c+="\n"+b+"}";case "function":return"<function>";case "string":return a;default:return String(a)}};f.Boot.__interfLoop=function(a,b){if(null==a)return!1;if(a==b)return!0;var c=a.__interfaces__;if(null!=c)for(var d=0,e=c.length;d<e;){var g=d++,g=c[g];if(g==b||f.Boot.__interfLoop(g,b))return!0}return f.Boot.__interfLoop(a.__super__,b)};f.Boot.__instanceof=
function(a,b){try{if(a instanceof b)return b==Array?null==a.__enum__:!0;if(f.Boot.__interfLoop(a.__class__,b))return!0}catch(c){if(null==b)return!1}switch(b){case N:return Math.ceil(a%2147483648)===a;case O:return"number"==typeof a;case L:return!0===a||!1===a;case String:return"string"==typeof a;case P:return!0;default:if(null==a)return!1;if(b==Q&&null!=a.__name__)return!0;null;if(b==R&&null!=a.__ename__)return!0;null;return a.__enum__==b}};f.Browser=function(){};h["js.Browser"]=f.Browser;f.Browser.__name__=
["js","Browser"];f.Browser.createXMLHttpRequest=function(){if("undefined"!=typeof XMLHttpRequest)return new XMLHttpRequest;if("undefined"!=typeof ActiveXObject)return new ActiveXObject("Microsoft.XMLHTTP");throw"Unable to create XMLHttpRequest object.";};Array.prototype.indexOf?g.remove=function(a,b){var c=a.indexOf(b);if(-1==c)return!1;a.splice(c,1);return!0}:null;Math.__name__=["Math"];Math.NaN=Number.NaN;Math.NEGATIVE_INFINITY=Number.NEGATIVE_INFINITY;Math.POSITIVE_INFINITY=Number.POSITIVE_INFINITY;
h.Math=Math;Math.isFinite=function(a){return isFinite(a)};Math.isNaN=function(a){return isNaN(a)};String.prototype.__class__=h.String=String;String.__name__=["String"];Array.prototype.__class__=h.Array=Array;Array.__name__=["Array"];Date.prototype.__class__=h.Date=Date;Date.__name__=["Date"];var N=h.Int={__name__:["Int"]},P=h.Dynamic={__name__:["Dynamic"]},O=h.Float=Number;O.__name__=["Float"];var L=h.Bool=Boolean;L.__ename__=["Bool"];var Q=h.Class={__name__:["Class"]},R={};"undefined"!=typeof JSON&&
(e.Json=JSON);l.buttons=[];y.regex=[{from:new n("\\x3E ([^\n]+)","g"),to:"<blockquote>$1</blockquote>"},{from:new n("___([^___]+)___","g"),to:"<b><i>$1</i></b>"},{from:new n("\\*\\*([^\\*\\*|\\*]+)\\*\\*","g"),to:"<b>$1</b>"},{from:new n("__([^__|_]+)__","g"),to:"<b>$1</b>"},{from:new n("\\*([^\\*|\\*\\*]+)\\*","g"),to:"<i>$1</i>"},{from:new n("_([^_|__]+)_","g"),to:"<i>$1</i>"},{from:new n("\\[([^\\]]+)\\]\\(([^\\)]+)\\)","g"),to:'<a href="$2">$1</a>'},{from:new n("(.*?)\n\\x3D=*","g"),to:"<h2>$1</h2>"},
...
"g"),to:"$1 "},{from:new n("\n[\\+\\*\\-] ([^\n]+)","g"),to:"<li><p>$1</p></li>"},{from:new n("\n[0-9]*[.\\):]([^\n]+)","g"),to:"<li><p>$1</p></li>"},{from:new n("\\x3Cli\\x3E([^\n+]+)\\x3C/li\\x3E",""),to:"<ul><li>$1</li></ul>"}];j.fullPage=!0;n=new e.ds.StringMap;n.set("adblock","Block advertisements and sponsors");n.set("userinfo","Show information about a user upon hover");n.set("subinfo","Show information about a subreddit upon hover");n.set("expand","Allow expansion of images");n.set("dup-hider",
"Hide duplicate links");n.set("user-tag","Tag users");n.set("sub-tag","Tag subreddits");n.set("preview","Preview comments and posts");n.set("keys","Keyboard shortcuts");n.set("nsfw-filter","Hide NSFW content");m.DESC=n;n=new e.ds.StringMap;n.set("adblock",!0);n.set("userinfo",!0);n.set("subinfo",!0);n.set("expand",!0);n.set("dup-hider",!0);n.set("user-tag",!0);n.set("sub-tag",!0);n.set("preview",!0);n.set("keys",!0);n.set("nsfw-filter",!0);n.set("user-tags",new e.ds.StringMap);n.set("sub-tags",new e.ds.StringMap);
m.DEFAULTS=n;m.data=new e.ds.StringMap;e.Serializer.USE_CACHE=!1;e.Serializer.USE_ENUM_INDEX=!1;e.Serializer.BASE64="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789%:";e.Unserializer.DEFAULT_RESOLVER=t;e.Unserializer.BASE64="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789%:";e.ds.ObjectMap.count=0;f.Browser.window="undefined"!=typeof window?window:null;f.Browser.document="undefined"!=typeof window?window.document:null;j.main()})();
